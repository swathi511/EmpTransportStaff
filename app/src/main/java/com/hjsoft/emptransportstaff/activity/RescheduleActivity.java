...
public class RescheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvRepDate=(TextView)findViewById(R.id.ar_tv_rep_date);
        tvRepTime=(TextView)findViewById(R.id.ar_tv_rep_time);
        tvWork=(TextView)findViewById(R.id.ar_tv_work);
        tvHome=(TextView)findViewById(R.id.ar_tv_home);
        etComments=(EditText)findViewById(R.id.ar_et_comments);
        tvSave=(TextView)findViewById(R.id.ar_tv_submit);
        ivRepDate=(ImageView)findViewById(R.id.ar_iv_rep_date);
        ivRepTime=(ImageView)findViewById(R.id.ar_iv_rep_time);
        tvMyProfile=(TextView)findViewById(R.id.ar_tv_my_profile);
    ...
    {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(RescheduleActivity.this);
...
//            it's before current'
                        Toast.makeText(RescheduleActivity.this, "Please Choose Time ahead of current time", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    // stDate=day+"/"+mnth+"/"+yr;
                    //stDate = day+"-"+mnth+"-"+yr;
    ...
    public void rescheduleTrip()
    {
        ...
        {
            Toast.makeText(RescheduleActivity.this,"Please enter Date/Time !",Toast.LENGTH_SHORT).show();
            ...
            v.addProperty("Remarks", stComments);

            System.out.println(stEmpId+":"+stDate+":"+stTime+":"+stPlace+":"+stComments);

            Call<Pojo> call = REST_CLIENT.reschedule(v);
            call.enqueue(new Callback<Pojo>() {
                ...
                public void onResponse(Call<Pojo> call, Response<Pojo> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        Toast.makeText(RescheduleActivity.this,"Trip Rescheduled !",Toast.LENGTH_SHORT).show();
                        Intent i=new Intent(RescheduleActivity.this,RescheduleHistoryActivity.class);
                        startActivity(i);
                        finish();
                    }
                    else {
...
//                        etComments.setEnabled(false);
                        ...
                        etComments.setText(" ");
                        Toast.makeText(RescheduleActivity.this,"Request already exist for the specified date !",Toast.LENGTH_LONG).show();
//                        Intent i=new Intent(RescheduleActivity.this,TripSummaryActivity.class);
//                        startActivity(i);
//                        finish();
                ...
                public void onFailure(Call<Pojo> call, Throwable t) {
                    ...
                    Toast.makeText(RescheduleActivity.this,"No Internet Connection!",Toast.LENGTH_SHORT).show();
